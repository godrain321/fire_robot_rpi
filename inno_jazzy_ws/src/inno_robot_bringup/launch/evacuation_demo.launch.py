...
def generate_launch_description():
    ...
    field_bringup = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "cmd_vel_output_topic": L("cmd_vel_output_topic"),
            ...
            "use_mode3_demo": L("use_mode3_demo"),
            "mode3_intro_audio_file": L("mode3_intro_audio_file"),
            "mode3_spin_speed_radps": L("mode3_spin_speed_radps"),
            "mode11_enabled": L("mode11_enabled"),
            "imu_topic": L("imu_topic"),
            "encoder_topic": L("encoder_topic"),
            "allow_virtual_step_counts": L("allow_virtual_step_counts"),
            "left_encoder_sign": L("left_encoder_sign"),
            "right_encoder_sign": L("right_encoder_sign"),
            "imu_yaw_sign": L("imu_yaw_sign"),
            "wheel_radius_m": L("wheel_radius_m"),
            "encoder_counts_per_rev": L("encoder_counts_per_rev"),
            "maximum_encoder_counts_per_sec": L("maximum_encoder_counts_per_sec"),
